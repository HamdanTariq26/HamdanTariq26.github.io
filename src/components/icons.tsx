// Small, hand-rolled line icons (24x24, stroke-based) — kept local so the
// project has no icon-font dependency. Matches the mono/technical visual
// language (precision hairline strokes, no fills).
...
export function IconLinkedin({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className={className}>
      ...
      <path d="M7.5 10.5v6M7.5 7.75v.01M11.5 16.5v-3.75c0-1.1.9-2 2-2s2 .9 2 2v3.75M11.5 12.75v3.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
